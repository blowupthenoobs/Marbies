...
public static class FolderIconEditor
{
    static FolderIconEditor()
    {
        ...
        SetFolderIcon("Assets/Sprites", "Assets/Editor/ClaraShy.png");
        ...
        SetFolderIcon("Assets/TextMesh Pro", "Assets/Editor/NotesPerson.png");
        SetFolderIcon("Assets/Scripts/UiAndManagement", "Assets/Editor/DigimonCoolio.png");
        SetFolderIcon("Assets/Photon", "Assets/Editor/ArcadeWut.png");
        SetFolderIcon("Assets/Animations", "Assets/Editor/WraithSmug.png");
        SetFolderIcon("Assets/Materials", "Assets/Editor/AA_Spin.gif");
    }
